...
class BasketBall(object):
    def __init__(self, input_type):
        ...
        self.max_speed = 100 # 最大力投球时，投球瞬间球的速度，单位m/s
            ...
            if R_wrist[1] < R_shoulder[1]:
                ...
                if not self.is_init:
                    ...
                    if self.ready_time >= self.ready_threshold and self.ready_theta - current_theta >= 30:
                        ...
                        cv2.imwrite(input_name+"_shot_"+str(self.record_num)+".jpg", frame_shot)
...
if __name__ == '__main__':
    ...
    cam = cv2.VideoCapture(input_name+".mov")
    ...
    print(video_fps)
    # 创建对象，用于视频的写出
    videoWrite = cv2.VideoWriter(input_name+'_output.mp4', fourcc, video_fps, (width,height))
    per_frame = 1/video_fps
